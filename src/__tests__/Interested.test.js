...
import Interested from '../pages/seller/Interested';
...
describe('Interested page', () => {
  beforeEach(() => {
    productAPI.getWishlistProductService = jest.fn().mockResolvedValue(mockResponse);
    store.dispatch(SET_TOKEN('123'));
    store.dispatch(CHANGE_AUTH(true));
    render(<InterestedComp />);
  });
