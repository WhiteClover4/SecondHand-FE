...
export default function SuccessCheckoutModal() {
  return (
    <div className="relative flex  w-[360px] flex-col rounded-2xl bg-neutral-01  px-8 pt-4 pb-6">
      ...
      <p className="mb-2  text-body-14 font-medium">Yeay kamu berhasil mendapat harga yang sesuai</p>
      <p className="mb-4  text-body-14 text-neutral-03">Segera hubungi pembeli melalui whatsapp untuk transaksi selanjutnya</p>
      <div className="mb-6 flex grow flex-col gap-4 rounded-2xl bg-[#EEEEEE] p-4">
        ...
        <div className="flex flex-row items-center">
          <img src="/img/img-profile1.png" alt="img-profile" className="mr-4 h-12 w-12 rounded-xl object-cover" />
